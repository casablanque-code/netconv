...
* @returns {string}
*/
export function convert_config(source_config, source_vendor, target_vendor) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.convert_config(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('netconv_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
